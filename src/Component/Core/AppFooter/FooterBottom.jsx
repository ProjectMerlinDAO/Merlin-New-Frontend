  ...
  return (
    <div className="py-[50px] xl:py-[30px] flex items-center justify-between md:justify-center font-[400] md:gap-[16px] md:flex-wrap">
        <ul className="flex items-center justify-start gap-[25px] flex-wrap sm:justify-center sm:gap-[10px]">
            <li><a href="/terms-and-Conditions" target="_blank" className="hover:text-white">Terms and conditions</a></li>
            <li><a href="/privacyPolicy" target="_blank" className="hover:text-white">Privacy policy</a></li>
            <li><a href="/assets/pdf/Project Merlin Whitepaper.pdf" target="_blank" className="hover:text-white">Whitepaper</a></li>
        </ul>
