      ...
      <div className='p-[70px] lg:p-[40px] overflow-hidden rounded-[40px] bg-gradient-to-l from-[#FFFFFF04] to-[#060cbf05] backdrop-blur-[5px]'>
        <div className="flex flex-wrap">
          <div className="w-2/3 lg:w-full">
            <a href="#"><Image src="/assets/images/logo/logo.svg" alt="logo" width="145" height="500" className='lg:mx-auto' /></a>
            <div className="flex items-start mt-[55px] lg:mt-[30px] justify-start text-[#ffffffd2] font-[400] lg:flex-wrap lg:max-w-[300px] lg:mx-auto">
              <div className="w-2/5 lg:w-full lg:mb-[20px] lg:text-center">
                <p className='max-w-[246px] lg:mx-auto leading-[24px]'>Copyright © <a href="#">ProjectMerlin</a>, 2024 All rights reserved.</p>
              </div>
          ...
          <div className="w-1/3 lg:w-full lg:text-center">
            <h2 className='mb-[50px] lg:mb-[20px] mt-[20px] uppercase quantico text-[26px] sm:text-[22px] font-[700] text-white'>Official Community</h2>
            <ul className="flex items-start justify-start md:justify-center mb-[40px] lg:mb-[20px] max-w-[370px] lg:mx-auto flex-wrap gap-[20px] sm:gap-[10px]">
              {socialIcons.map((icon, index) => (
                <li key={index} className='social-icon-btn'>
                  <a href={icon.href} className='flex btn-has-shape items-center justify-center rounded-[16px] sm:rounded-[10px] bg-[#FFFFFF05] backdrop-blur-[5px] h-[70px] w-[70px] sm:h-[50px] sm:w-[50px]' >
            ...
            <a href="#" className='hov-btn btn-has-shape gap-[10px] bg-[#5865F2] rounded-full h-[60px] w-[220px] lg:mx-auto flex items-center justify-center text-white text-center leading-trim-both text-edge-cap font-[600] text-[16px] uppercase quantico' >
              <Image src="/assets/images/icons/discord.svg" alt="icon" className='mt-[0px]' width="25" height="500" />
