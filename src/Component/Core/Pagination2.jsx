  ...
  return (
    <div className="merlin-pagination">
        <ul className='flex items-center justify-start gap-[10px]'>
            ...
            <li><a href="#" className='flex items-center justify-center rounded-[12px] sm:rounded-[8px] h-[40px] w-[40px] sm:h-[30px] sm:w-[30px] bg-transparent border border-[#ffffff26] hover:bg-[#ffffff26] hover:text-[#12CFA7] duration-[0.4s]'>...</a></li>
            <li><a href="#" className='flex items-center justify-center rounded-[12px] sm:rounded-[8px] h-[40px] w-[40px] sm:h-[30px] sm:w-[30px] bg-transparent border border-[#ffffff26] hover:bg-[#ffffff26] hover:text-[#12CFA7] duration-[0.4s]'>89</a></li>
