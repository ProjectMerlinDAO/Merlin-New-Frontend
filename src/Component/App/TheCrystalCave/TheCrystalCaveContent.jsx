    ...
    >
      ...
      >
        <div className="px-[20px] md:px-[10px] max-w-[1365px] mx-auto lg:max-w-[720px]">
          <ul className="cursor-pointer flex items-cenetr  justify-start gap-[8px] uppercase relative pl-[48px] z-[99999] mb-[30px] 2xl:text-[14px] xl:ml-[100px] lg:ml-[0px] md:flex-wrap">
