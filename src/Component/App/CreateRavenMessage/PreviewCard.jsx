    ...
    return (
        <div classNAme="mt-[50px]">
            ...
            <div className="p-[30px] mt-[10px] rounded-[30px]" style={{ background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0.02) 100%)' }}>
                ...
                <h4 className="text-white text-[20px] font-[400] lexend mb-25px">Untitled</h4>
                <ul className="preview-card-list">
                    <li className="flex items-center relative justify-between py-[20px]" ><span>Goal</span> <span>0.00 MRLN</span></li>
                    <li className="flex items-center relative justify-between py-[20px]" ><span>Category</span> <span>--</span></li>
                </ul>
