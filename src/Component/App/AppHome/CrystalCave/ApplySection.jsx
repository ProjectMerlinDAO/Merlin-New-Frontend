  ...
  return (
    <div className='rounded-[30px] overflow-hidden bg-cover bg-no-repeat bg-center mt-[40px]' style={{backgroundImage: `url('../assets/images/bg/apply-bg.jpg')`}}>
        <div className='pt-[70px] pb-[60px] lg:py-[40px] px-[20px] text-center bg-gradient-to-b from-[transparent] to-[#0d1014b2]'>
            ...
            <Link href="/create-raven-message" className='hov-btn btn-has-shape apply-btn gap-[7px] bg-[#ffffff10] rounded-full bg-opacity-10 backdrop-blur-[5px] h-[60px] w-[220px] mx-auto flex items-center justify-center text-white text-center leading-trim-both text-edge-cap font-[600] text-[16px] uppercase quantico' 
            >
