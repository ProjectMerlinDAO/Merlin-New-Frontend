        ...
        <Tabs>
            <div className="flex items-center justify-between gap-[15px] flex-wrap mb-[35px] sm:flex-wrap]">
                <TabList className="flex items-center justify-start gap-[20px] xsm:w-full">
                    <Tab onClick={() =>setType("active")} className={`my-message-btn cursor-pointer ${Type && Type === "active" ? "active-btn" : "passive-btn"} hov-btn bg-[rgba(255,255,255,0.05)] rounded-[15px] h-[50px] relative w-[120px] xsm:w-1/2 flex items-center justify-center text-white text-center  font-[600] text-[16px] uppercase quantico`}>
                        <span className="btn-hov-text">
                        <span className="btn-text" >Active</span>
                        <span className="btn-text" >Active</span>
                        </span>
                    </Tab>
                    <Tab onClick={() =>setType("passive")} className={`my-message-btn cursor-pointer ${Type && Type === "active" ? "active-btn" : "passive-btn"} hov-btn bg-[rgba(255,255,255,0.05)] rounded-[15px] h-[50px] relative w-[120px] xsm:w-1/2 flex items-center justify-center text-white text-center  font-[600] text-[16px] uppercase quantico`}>
                        <span className="btn-hov-text">
