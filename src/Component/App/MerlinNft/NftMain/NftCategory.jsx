      ...
      <NftContainerWrapper>
        <div className="flex items-center justify-between mx-[-15px] lg:flex-wrap">
          {categories.map((category, index) => (
            <div className="w-2/6 lg:w-1/2 sm:w-full px-[15px] lg:mb-[20px] last:mb-0 cursor-pointer" key={index} onClick={category.name === "Project Merlin" || category.name === "Supported Projects" ? () => openModal(category.name) : null}>
