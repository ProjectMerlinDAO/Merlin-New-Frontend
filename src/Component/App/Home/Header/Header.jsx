        ...
        <div className="flex items-center justify-between py-[9px]">
          ...
          <div className="center max-w-[529px] w-full mx-auto lg:hidden">
            <ul className='flex items-center justify-between w-full text-white uppercase quantico'>
              <li><Link href={router.pathname === "/" ? "#home" : "/"}>Home</Link></li>
          ...
          <div className="right">
            <Link href="/launch-app" className="buy-btn btn-has-shape hov-btn bg-[#FFFFFF] rounded-full h-[50px] w-[150px] sm:w-[120px] flex items-center justify-center text-[#111111] text-center  font-[600] text-[16px] sm:text[14px] uppercase quantico lg:hidden">
