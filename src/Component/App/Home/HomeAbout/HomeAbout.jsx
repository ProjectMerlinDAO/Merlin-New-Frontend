                ...
                <div className="flex items-start justify-between flex-wrap mx-[-15px]">
                    ...
                    <div className="w-1/2 md:w-full px-[15px] lg:mt-[30px]">
                        <div className="about-marlin-img relative max-w-[450px] ml-auto md:max-w-[300px] md:mx-auto md:min-h-[320px] flex items-center justify-center">
                            <div className="min-w-[300px] min-h-[300px] max-w-[300px] max-h-[300px] lg:max-w-[200px] lg:max-h-[200px] lg:min-w-[200px] lg:min-h-[200px] absolute rounded-[30px] md:rounded-[25px] overflow-hidden left-0 top-0 z-0">
                                <img src="../assets/images/img/merlin1.gif" alt="img" className='w-full m-auto rounded-[30px] md:rounded-[25px]' />
                            </div>
                            <div className="min-w-[300px] min-h-[300px] max-w-[300px] max-h-[300px] lg:max-w-[200px] lg:max-h-[200px] lg:min-w-[200px] lg:min-h-[200px] absolute rounded-[35px] md:rounded-[30px] bg-[rgba(13,16,20,0.50)] backdrop-blur-[5px] p-[10px] flex items-center justify-center overflow-hidden right-0 top-[130px] z-20">
                                <img src="../assets/images/img/merlin2.gif" alt="img" className='w-full m-auto rounded-[30px] md:rounded-[25px]' />
                            </div>
