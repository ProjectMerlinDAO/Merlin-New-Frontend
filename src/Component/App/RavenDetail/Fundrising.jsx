...
const Fundrising = ({ timer, goal, setIsOpen, wallet, amtRaised }) => {
    ...
    <div className='rounded-[20px] backdrop-blur-[5px] p-[40px] 2xl:p-[20px] relative fundrising-card mb-[30px]' style={{ background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0.00) 100%)' }}>
      <div className='relative z-10'>
        ...
        <div className="h-[20px] rounded-[10px] bg-[#ffffff19] w-full mt-[25px] mb-[15px]">
          <div className={`bg-[#12CFA7] rounded-[10px] text-white text-[14px] quantico flex items-center justify-end gap-[5px] h-[20px] w-[${percentAmt.toFixed(2)}px]`}>
        ...
        <ul className="fundrising-list 2xl:text-[15px]">
          <li className='relative flex items-center justify-between py-[15px] text-white'><span>Raised</span> <span>{amtRaised ? `${amtRaised.toFixed(2)} USDT (${goal * mrlnTokenPrice} MRLN)` : '0 USDT(0 MRLN)'}
          </span></li>
